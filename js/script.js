jQuery(document).ready(function($) {
    initButtons = function() {
        ...
        $('.ioa-proceed').click(function(e) {
            ...
            $.ajax({
                url: ajaxurl,
                data: { action: action, file: file,  _ajax_wpio_nonce: $('#_ajax_wpio_nonce').val() },
                type: 'post',
                dataType: 'json',
    ...
    scan_images = function(datas) {
        ...
        $.ajax({
            url: ajaxurl,
            data: { action: 'wpio_scan_images', datas: datas, _ajax_wpio_nonce: $('#_ajax_wpio_nonce').val()  },
            type: 'post',
            dataType: 'json',
    ...
    $(".wpio_scan_images").click(function() {
        ...
        $.ajax({
            url: ajaxurl,
            data: { action: 'wpio_count_images',  _ajax_wpio_nonce: $('#_ajax_wpio_nonce').val()  },
            type: 'post',
            dataType: 'json',
            success: function(response) {
