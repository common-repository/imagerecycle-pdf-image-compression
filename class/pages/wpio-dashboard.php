...
<?php  wp_nonce_field('ajax-wpio_nonce', '_ajax_wpio_nonce'); ?>
<script>
    window.addEventListener("message",
        function (e) {
            ...
            jQuery.ajax({
                url: ajaxurl,
                data: {action: 'wpio_createAccount', key: accountData.key, secret: accountData.secret,  _ajax_wpio_nonce: jQuery('#_ajax_wpio_nonce').val()},
                type: 'post',
                dataType: 'json',
